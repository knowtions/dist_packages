...
http://vault.centos.org/7.7.1908/os/x86_64/Packages/elfutils-libelf-0.176-2.el7.x86_64.rpm
http://vault.centos.org/7.7.1908/os/x86_64/Packages/elfutils-libelf-devel-0.176-2.el7.x86_64.rpm
...
kernel_packages=$(cat kernel_packages_list.txt | grep -v "^#" | xargs)
